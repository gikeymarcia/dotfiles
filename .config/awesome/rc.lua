...
home_dir = "/home/mikey/"
def_theme = home_dir .. ".config/awesome/default-theme.lua"
beautiful.init( def_theme )
revelation.init()
...
-- Default modkey -- Mod4 is Windows key
modkey = "Mod4"
...
-- MOVING thru STACK -- win + [ j, k ]
    awful.key({ modkey,           }, "j",
        function () awful.client.focus.byidx( 1) end,
        {description = "focus up stack", group = "client"}),
    awful.key({ modkey,           }, "k",
        function () awful.client.focus.byidx(-1) end,
        {description = "focus down stack", group = "client"}),
...
-- LAYOUT MANIPULATION
    ...
    -- changing screens -- win + Control + [ j, k ]
...
-- LAUNCHERS
    -- run menu
    awful.key({ modkey },            "d",
        function () awful.util.spawn(home_dir .. ".scripts/launchers/run-menu.sh", false) end,
    ...
    awful.key({ modkey, "Control" }, "Return",
        function () awful.util.spawn(home_dir .. ".scripts/dmenu/change-terminal-xcolors.sh", false) end,
        {description = "change  terminal styling", group = "launcher"}),
    awful.key({ modkey, }, "F10",
        function () awful.util.spawn(home_dir .. ".scripts/launchers/keepassxc.themed.sh", false) end,
        {description = "keepass", group = "launcher"}),

    -- web browsers
    awful.key({ modkey },            "p",
        function () awful.util.spawn("firefox -private") end,
        {description = "firefox (incognito)", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "p",
        function () awful.util.spawn("brave-browser --incognito") end,
...
-- MR. MANAGER
    ...
    awful.key({ modkey , "Control" }, "c",
        function () awful.util.spawn(home_dir .. ".scripts/launchers/compositor.sh", false ) end,
        {description = "change compositor profile", group = "system"}),
    awful.key({ modkey}, "F12",
        function () awful.util.spawn(home_dir .. ".scripts/launchers/i3lock.sh", false ) end,
        {description = "change compositor profile", group = "system"}),
    awful.key({ modkey , "Control" }, "v",
        function () awful.util.spawn(home_dir .. ".scripts/launchers/clipboard-manager.sh", false ) end,
        {description = "toggle clipboard manager", group = "system"}),
    awful.key({ modkey , "Control" }, "n",
        function () awful.util.spawn(home_dir .. ".scripts/launchers/nightmode.sh toggle", false ) end,
...
-- HARDWARE
    awful.key({ }, "XF86AudioRaiseVolume",
        function () awful.util.spawn(home_dir .. ".scripts/system/volume-control.sh up", false ) end,
        {description = "raise volume", group = "hardware"}),
    awful.key({ }, "XF86AudioLowerVolume",
        function () awful.util.spawn(home_dir .. ".scripts/system/volume-control.sh down", false ) end,
        {description = "lower volume", group = "hardware"}),
    awful.key({ }, "XF86AudioMute",
        function () awful.util.spawn(home_dir .. ".scripts/system/volume-control.sh mute", false ) end,
        {description = "mute audio", group = "hardware"}),
    awful.key({ }, "XF86MonBrightnessUp",
        function () awful.util.spawn(home_dir .. ".scripts/commands/macbook-backlight.sh up", false ) end,
        {description = "screen backlight up", group = "hardware"}),
    awful.key({ }, "XF86MonBrightnessDown",
        function () awful.util.spawn(home_dir .. ".scripts/commands/macbook-backlight.sh down", false ) end,
        {description = "screen backlight down", group = "hardware"}),
    awful.key({ }, "XF86KbdBrightnessUp",
        function () awful.util.spawn(home_dir .. ".scripts/commands/macbook-keyboard-led.sh up", false ) end,
        {description = "keyboard backlight up", group = "hardware"}),
    awful.key({ }, "XF86KbdBrightnessDown",
        function () awful.util.spawn(home_dir .. ".scripts/commands/macbook-keyboard-led.sh down", false ) end,
...
clientkeys = gears.table.join(
    awful.key({ modkey,           }, "Tab",
        function (c)
            local prev = awful.client.focus.history.get(awful.screen.focused(),1)
            c:swap(prev)
            awful.client.focus.history.previous ()
        end,
        {description = "swap with last focused", group = "client"}),
...
-- focus
    ...
    awful.key({ modkey, "Control"  }, "s",
        ...
        {description = "make window sticky across tags", group = "client"}),
-- minimize
